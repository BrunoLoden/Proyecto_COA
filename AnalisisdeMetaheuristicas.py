...
if __name__=="__main__":
     ...
     for i in range(n_exper):
        ...
        PSO(F2,initial0,bounds,num_particles=50,maxiter=60)
        GSA(F2, np.array(LL), np.array(LU), 9, 50, 60)
        t2=time.time()
        best,para,iteracion=apply(50, 9, boundsA, F2,opts=None,memory_size=100,callback=None,max_evals=3000,seed=None)
        ...
        plt.ylabel('Desviaciones de Voltaje (p.u.)')
        plt.legend(loc='best')
